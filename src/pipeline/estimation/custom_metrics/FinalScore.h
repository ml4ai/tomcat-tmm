    ...
    namespace model {
        ...
        class FinalScore : public SamplerEstimator {
          public:
             ...
             * @param marginals: marginal distributions for nodes that were rao-blackwellized
          ...
          private:
            ...
            // Last samples where regular and critical victims were being
            // rescued. The vectors are binary and will be used to determine
            // whether victims finished being rescued when new particles are
            // received.
